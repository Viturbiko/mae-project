...
<div class="container_calendar">
	...
	<div class="content_calendar">
		...
		<div class="calendar">
					...
					<div class="calendar_days">
						...
						<div class="event_day" onmouseover="changeImage('lisbon.jpg', 'THE &quot;MED ATLANTIC ECOBONUS&quot; <br> PROJECT FINAL EVENT')">
							...
							<div class="event_day" onmouseover="changeImage('lisbon_2.jpg', 'LISBON')">
								<p>October 2018</p>
														<h1>28</h1>
														<hr align="center" width="50%">
								<p>Informing and gettin feedback on the MAE approeach from local stakeholders.</p>
							</div>

						
							<div class="event_day" onmouseover="changeImage('madrid.jpg', 'MADRID')">
								<p>October 2018</p>
														<h1>29</h1>
														<hr align="center" width="50%">
								<p>Informing and gettin feedback on the MAE approeach from local stakeholders.</p>
							...
							<div class="event_day" onmouseover="changeImage('brussels.jpg', 'BRUSSELS')">
								<p>November 2018</p>
														<h1>8</h1>
														<hr align="center" width="50%">
								<p>Consensus Workshop. Idnustry takeholders</p>
							</div>
							...
							<div class="event_day" onmouseover="changeImage('paris.jpg', 'PARIS')">
								<p>November 2018</p>
														<h1>TBC</h1>
														<hr align="center" width="50%">
								<p>Informing and gettin feedback on the MAE approeach from local stakeholders.</p>
		...
		<div class="calendar_container" style="display: none">
			...
			<div class="events_container">
				...
				<div class="event">
					...
					<div class="event_info">
						<p class="event_title"><b>Informing and getting feedback on the MAE approach from local stakeholders</b></p>
						<p>Lisbon</p>
					</div>
				...
				<div class="extra_info" id="info_3">	
					<p>To be confirmed. November 2018</p>
					<p>Paris</p>
				...
				<div class="event">
					<img src="/images/events/event-4.jpg" alt="">
					<div class="event_date">
						<h1>TBC</h1>
						<p>NOVEMBER</p>
					</div>
				...
				<div class="event">
					<img src="/images/events/event-5.jpg" alt="">
					<div class="event_date">
						<h1>08</h1>
						<p>NOVEMBER</p>
					</div>
				...
				<div class="event">
					...
					<div class="event_info">
						<p class="event_title" style="color: #fd0101;"><b>MAE FINAL EVENT</b></p>
						<p>Lisbon. Auditório Rocha Conde d Óbidos.</p>
					</div>
				...
				<div class="event">
					<img src="/images/events/event-7.jpg" alt="">
					<div class="event_date">
						<h1>TBC</h1>
						<p>DECEMBER</p>
					</div>
				...
				<div class="event">
					<img src="/images/events/event-8.jpg" alt="">
					<div class="event_date">
						<h1>TBC</h1>
						<p>DECEMBER</p>
					</div>
					...
					<img class="arrow_down" src="/images/events/flecha_down.png" alt="" id="arrow_9">
				</div>

				<div class="extra_info" id="info_9">
					<ul>
